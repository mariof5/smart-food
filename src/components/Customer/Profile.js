      ...
      <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div className="card-header bg-primary text-white p-4">
          <div className="d-flex align-items-center">
            <div className="position-relative me-4">
              <div className="profile-avatar-wrapper shadow-lg">
                {previewImage ? (
                  ...
                  <div className="profile-avatar-placeholder rounded-circle d-flex align-items-center justify-content-center bg-white text-primary">
            ...
            <div>
              <h3 className="mb-1 fw-bold">{userData?.name || 'User Profile'}</h3>
        ...
        <div className="card-body p-0">
          <ul className="nav nav-tabs nav-fill border-0 bg-light p-1">
            <li className="nav-item">
              <button
                className={`nav-link border-0 rounded-pill py-3 transition-all ${activeTab === 'info' ? 'active bg-white shadow-sm text-primary fw-bold' : 'text-muted'}`}
            ...
            <li className="nav-item">
              <button
                className={`nav-link border-0 rounded-pill py-3 transition-all ${activeTab === 'security' ? 'active bg-white shadow-sm text-primary fw-bold' : 'text-muted'}`}
              ...
              <form onSubmit={handleUpdateProfile}>
                <div className="row g-4">
                  ...
                  <div className="col-12 pt-2">
                    <button type="submit" className="btn btn-primary px-5 py-2 rounded-pill shadow-sm" disabled={loading}>
                      {loading ? (
